...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7583081527:AAF2WXszvqyz6RP8_MkO5e8Tq34QijK2GUQ")
    DATABASE_NAME = os.environ.get("DATABASE_NAME", "tg_bot")
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://chitijvashnavi:mongodb890@king.kb2x4lp.mongodb.net/?retryWrites=true&w=majority&appName=king")
    OWNER_ID = int(os.environ.get("OWNER_ID", "1003575883"))
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002566117512"))
